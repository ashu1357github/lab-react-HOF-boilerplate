...
class HigherOrderComponent extends Component {
  constructor() {
    ...
    this.state = {
      userData: [
        { id: "1", name: "John", user_type: "Developer", age: 31, years: 11 },
        { id: "2", name: "Hill1", user_type: "Designer", age: 26, years: 4 },
        { id: "3", name: "John2", user_type: "Teacher", age: 24, years: 2 },
        { id: "4", name: "Sammy", user_type: "Entreprenuer", age: 58, years: 25 },
        { id: "5", name: "Jocky", user_type: "Designer", age: 43, years: 18 },
      ],
    };
  }
